...
def sanitize_sql_table_name(table_name: str) -> str:
    ...
    # Replace multiple consecutive underscores with a single one using split/join
    # sanitized_name = re.sub(r"_{2,}", "_", sanitized_name) # This was not working reliably
...
def sanitize_file_name(filepath: str) -> str:
    ...
    # Sanitize using the modified function (which already returns lowercase)
